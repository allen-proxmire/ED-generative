...
| SE-BlindnessInvariant | Crystals, Not Knots: What Correlation a Substrate Can Carry, and Why Topological Defects Are a Different Question (the blindness/common-cause invariant, 5-arc; scoped to correlation-order, explicitly silent on topological defects) | substrate-evaluation | WRITTEN | `physics-papers/substrate-evaluation/Paper_BlindnessInvariant_CrystalsNotKnots.md` (+ `.pdf`) |
