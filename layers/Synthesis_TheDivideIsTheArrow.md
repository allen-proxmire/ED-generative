...
- **Reversible structure-PRESERVING → an edge.** Solitons: a reversible balance the bare substrate does not strike on its own. **The committal rule does not supply it at the bottom** — a soliton needs an added focusing medium (a higher layer), not a claim that solitons can't exist.
