...
**Status: the unification is of MECHANISM, not of substance — and the mechanism is ED's interference cross-term, which is corpus-grounded. (The 2026-07-19 khronon-mode "falsification" was retracted the same day as a wrong-variable artifact; the horizon-`a₀` derivation then located the correct structure.)**
