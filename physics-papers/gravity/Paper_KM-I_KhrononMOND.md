...
| Modified Poisson $∇·[μ_{\rm tot}∇Φ] = 4πGρ$, $μ_{\rm tot} = 1 + c_{1W}'$ | **D** | §4.2 — form-level; constants conventional |
...
- **$W(A²)$ / $𝒲(A², Θ)$.** The acceleration kinetic function and its regulated completion; $μ_{\rm tot} = 1 + c_{1W}'$.
