...
1. **The preferred-frame front.** The khronon's coupling parameters (`α₁, α₂` in the PPN expansion) are not yet computed; once the substrate rule's coefficients are pinned, they either sit inside the solar-system and pulsar bounds or the theory dies. This has been the declared falsification target since GR-II, and nothing in the later papers shields it.
