...
| Radiative gravity (binary pulsars / GW) | **OPEN TENSION** | §6, §10.4; weak-field dynamical-metric data the kinematic account must address, not deferrable |
...
**The sharpest live tension, stated plainly (not deferred).** An acoustic/kinematic metric does not obviously radiate energy as self-propagating spin-2 waves. But binary-pulsar orbital decay (Hulse-Taylor, the double pulsar) and gravitational-wave inspirals (LIGO) are **weak-field, radiative** confirmations of exactly that dynamical-metric behaviour, quadrupole energy loss and metric waves carrying energy, matched to GR at sub-percent, and they are **not** extreme-density (so the strong-field hedge of §9 does not cover them). This is the sharpest standing tension for the MOND-not-Einstein stance, and it is open, not deferred: ED must either exhibit a radiative sector of the bandwidth field that reproduces quadrupole loss, or accept binary-pulsar / GW radiation as a live potential-falsifier (§10.4).
...
- **Radiative gravity is a live tension, not deferred (§6).** Binary-pulsar orbital decay and gravitational-wave inspirals are *weak-field, radiative* confirmations of dynamical-metric (Einstein) behaviour, spin-2 waves carrying energy, which a kinematic acoustic metric does not obviously reproduce, and they are not extreme-density. This is the sharpest standing potential-falsifier and is open; it is not covered by the strong-field hedge below.
...
**Falsifier sentence:** *Two live instances. (a) Radiative: binary-pulsar orbital decay and gravitational-wave inspirals already confirm dynamical-metric (spin-2, energy-carrying) behaviour in the weak field; unless ED exhibits a bandwidth-field radiative sector reproducing quadrupole loss, this is a standing potential-falsifier of the kinematic-metric stance (§6). (b) Galactic: rotation curves requiring dark matter rather than the MOND interpolation, or the absence of the deep-MOND regime, would falsify the MOND-covariantization prediction. These are the sharp ED-vs-GR discriminators, and (a) is not deferrable to strong field.*
