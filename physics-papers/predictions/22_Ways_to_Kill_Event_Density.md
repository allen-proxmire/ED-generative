...
**5. Cosmological-constant magnitude.** The smallness of $\Lambda$ is reframed as $(H_0/M_P)^2 \approx 10^{-122}$, not a separate coincidence to explain. *Kill it:* independent evidence that $\rho_\Lambda \neq (3/8\pi)H_0^2 M_P^2$.
