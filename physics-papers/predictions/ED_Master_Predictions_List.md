...
| **1.15 ⭐ FLAGSHIP** | **The MOND acceleration scale evolves with redshift as $a_0(z) = cH(z)/(2\pi)$** — a$_0$ is *not* a constant of nature (MOND) nor absent (ΛCDM); it tracks the instantaneous Hubble rate, so $a_0(z)/a_0(0) = H(z)/H_0$ (×1.3 at $z{=}0.5$, ×1.8 at $z{=}1$, ×3 at $z{=}2$). *The ED-vs-MOND weapon in the gravity sector — distinctive, parameter-free in shape, and the data are live.* | **structural / D** (composition of $a_0=cH_0/(2\pi)$ [029] + continuum-invariance [037]; `Paper_038` CO-3). **Data-confronted + direct α fit (2026-07-14, addendum A10):** MUSE-DARK III (A&A 2026) detects $a_0$ evolution at **~30σ** and the implied power is **$\alpha = 1.18 \pm 0.04$** (stat). **MOND ($\alpha{=}0$) dead at 29σ; ED ($\alpha{=}1$) at +4.4σ — a *tension*.** BUT the ±0.04 is underestimated (linear-fit-as-proxy, unpublished covariance, one survey, high-z systematics) → honest tension ~1–2σ. Local intercept $1.0\times10^{-10}$ matches ED's $1.08$ to 8%. **Honest status: ED far closer than MOND, but its exact $a_0=cH(z)/(2\pi)$ is *disfavored, not confirmed* — mild-to-moderate tension.** | The **decisive test = a direct *raw-data* $a_0\propto H(z)^\alpha$ fit** across surveys (MUSE-DARK galaxies + $z{\sim}0.9$–2.4 rotation curves) with a full error budget — not a re-reading of one linear fit. $\alpha{=}1$ would confirm ED; current $\alpha{\approx}1.18$ tensions it; $\alpha{=}0$ excluded. *Source: `Paper_038` CO-3 + `Paper_029`; MUSE-DARK III A&A 2026.* |
...
**⭐ FLAGSHIP forward test (added 2026-07-14) — 1.15, the redshift evolution of $a_0$.** ED predicts $a_0(z)=cH(z)/(2\pi)$: the MOND acceleration scale is not a constant (MOND) but tracks the Hubble rate, growing ×1.8 by $z{=}1$, ×3 by $z{=}2$. This is the corpus's sharpest *live, data-confronted, ED-vs-MOND* prediction — MUSE-DARK III (2026) detects $a_0$ evolution at ~30σ (killing MOND-constant) and matches ED's local value to 8%. **The direct α fit (2026-07-14) gives $\alpha = 1.18\pm0.04$(stat): MOND's α=0 dead at 29σ, but ED's α=1 is +4.4σ — a *tension*, softened to ~1–2σ once the linear-fit-proxy + one-survey systematics are folded in.** So ED is far closer than MOND but its exact $H(z)$ rate is *disfavored, not confirmed*. Still the near-term prediction most likely to single ED out — and the one to watch as more surveys report — but honestly under mild tension now, not a win. Decisive resolution: a direct raw-data $a_0\propto H(z)^\alpha$ fit across surveys.
