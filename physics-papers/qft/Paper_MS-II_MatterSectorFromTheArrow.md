...
**4.2 Chirality $\gamma^5$ is the arrow's screw *(structural).*** A commitment advances time and twists the P09 phase; the handedness of that twist is a spatial handedness — the "screw." The non-hermitian (retarded) transport carries a net point-gap winding / spectral-flow (a chiral signature absent in the hermitian case), located as a **channel-topology class**: $\gamma^5$ is which screw-handedness class the channel belongs to.
